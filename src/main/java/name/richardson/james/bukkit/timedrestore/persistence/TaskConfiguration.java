...
/**
 * The class TaskConfiguration represents the base {@link YAMLStorage} and
 * provides ways to access the configuration objects within.
 */
public class TaskConfiguration extends YAMLStorage {

	public TaskConfiguration(final File file, final InputStream defaults) throws IOException {
		super(file, defaults);
	}
