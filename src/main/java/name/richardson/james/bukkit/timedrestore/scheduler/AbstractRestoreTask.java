 ...
 * interface and should be inherited other implementation of it. This is done to
 * share a logger throughout the classes and set the
 * {@link TaskConfigurationEntry} for each task in a consistent way.
 */
public abstract class AbstractRestoreTask implements RestoreTask {

	final protected static Logger logger = new Logger(AbstractRestoreTask.class);
